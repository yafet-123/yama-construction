          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {categories.map((cat) => (
              <Link
                ...
                className="bg-white border border-concrete-secondary hover:border-safety-orange transition-all duration-300 group"
              >
                ...
                <div className="p-5 bg-concrete-secondary flex flex-col justify-between">
            ...
            {featuredProducts.map((product) => (
              <div key={product.id} className="card-product bg-white">
                ...
                <div className="">
                  ...
                  <div className="flex gap-2 bg-concrete-secondary px-3 py-5">
