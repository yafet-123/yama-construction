...
export const brands: Brand[] = [
  ...
  { name: 'New Holland', slug: 'new-holland', logo: '/images/brands/new-holland.svg', description: 'Global brand of agricultural machinery and construction equipment.' },
  { name: 'ROSTSELMASH', slug: 'rostselmash', logo: '/images/brands/rostselmash.svg', description: 'Manufacturer of agricultural equipment, including combine harvesters.' },
